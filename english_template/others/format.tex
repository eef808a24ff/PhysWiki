...
\newcommand{\pentry}[1]{\begin{mdframed}\bb{Prerequisites\ } #1 \end{mdframed}\vspace{-0.3cm}\par}%预备知识的格式
\newcommand{\rentry}[1]{\begin{mdframed}\bb{See also\ } #1 \end{mdframed}\vspace{-0.3cm}\par}%拓展阅读的格式
\newcommand{\eentry}[1]{\begin{mdframed}\bb{Used in\ } #1 \end{mdframed}\vspace{-0.3cm}\par}%应用举例的格式
