...
\newcommand{\Code}[1]{\subsubsection{#1.m}\lstinputlisting[language=MyMatlab]{./codes/#1.m}} % 插入 Matlab 代码（含标题）
\newcommand{\code}[1]{\lstinputlisting[language=MyMatlab]{./codes/#1.m}} % 插入 Matlab 代码（不含标题）
...
\newcommand{\exampautorefname}{Example}
\newcommand{\exercautorefname}{Exercise}
\newcommand{\definiautorefname}{Def.}
\newcommand{\lemmautorefname}{Lemma}
\newcommand{\theorautorefname}{Theorem}
\newcommand{\corolautorefname}{Corollary}
