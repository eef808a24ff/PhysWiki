...
% 其他
\newcommand{\entry}[2]{\section{#1}\label{#2}\input{./contents1/#2}}% 主程序中使用，从 contents 文件夹加入词条
\newcommand{\Entry}[2]{\section{#1}\label{#2}\input{./contents/#2}}% 从 contents1 中加入词条（contents1 里面用于存放超出力学分册的内容）
