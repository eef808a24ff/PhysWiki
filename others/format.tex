...
\newenvironment{issues}[1]{\begin{mdframed}\begin{itemize}#1}{\end{itemize}\end{mdframed}\vspace{-0.3cm}\par} % 词条问题框
\newcommand{\issueNoCite}{\item 本词条需要加入参考文献}
\newcommand{\issueDraft}{\item 本词条处于草稿阶段， 欢迎补全}
\newcommand{\issueOther}[1]{\item #1}
